...
# Substitute: contagion, coworld-contagion, 6.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-contagion:ci)
#   SMOKE_SLUG                 game slug                        (contagion)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/contagion)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/contagion-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-contagion:ci}}"
slug="${SMOKE_SLUG:-contagion}"
